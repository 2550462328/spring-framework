...
public class BeanDefinitionParserDelegate {
	...
	public void initDefaults(Element root, @Nullable BeanDefinitionParserDelegate parent) {
		// 将xml文件中的一些命名空间的基本配置(default-*)转换到DocumentDefaultsDefinition 对象中，作为后面解析BeanDefinition时的默认值配置
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		 ...
		 // ParseState类里面有一个private final Stack<Entry> state;栈；存放的对象类型是 Entry
		 // ParseState简单的栈结构来跟踪逻辑位置中解析过程，主要是记录异常信息；在异常的时候 Spring调用error方法，会把ParseState栈中的信息一起抛出
